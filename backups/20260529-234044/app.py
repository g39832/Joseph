...
from hyper.bootstrap import enhance_response, get_context_enhancement, shutdown_hyper
...
class JosephApp(ctk.CTk):
    ...
    def _llm_worker(self, user_text: str):
        ...
        try:
            ...
            extra_context = get_context_enhancement(self._hyper, user_text)
            if extra_context:
            ...
            if self._hyper and full_response:
                try:
    ...
    def _handle_voice_text(self, text: str) -> str:
        ...
        try:
            ...
            extra_context = get_context_enhancement(self._hyper, text)
            if extra_context:
                memory_context = f"{memory_context}\n\n{extra_context}" if memory_context else extra_context
            system_prompt = get_system_prompt(
                user_name=settings.USER_NAME,
